...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Python port of examples/tetrahedra/Tetrahedralize.cxx"
    )
    parser.add_argument("in_data")
    parser.add_argument("out_data", nargs="?", default="out_tets.vtk")
    ...
    # Tetrahedralize the data set.
    tetrahedralize_filter = Tetrahedralize()
    output_dataset = tetrahedralize_filter.Execute(input_dataset)
