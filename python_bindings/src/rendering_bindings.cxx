  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  nb::class_<viskores::cont::ColorTable>(m, "ColorTable")
  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  nb::class_<viskores::rendering::Camera>(m, "Camera")
    .def(nb::init<>())
    .def("GetLookAt",
  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  auto make_actor_with_field =
    [](const auto& dataObject, const std::string& fieldName) {
  ...
  nb::class_<viskores::rendering::Actor>(m, "Actor")
    .def("__init__",
  ...
  nb::class_<viskores::rendering::Scene>(m, "Scene")
    .def(nb::init<>())
    .def("AddActor",
         [](viskores::rendering::Scene& self,
            const std::shared_ptr<viskores::rendering::Actor>& actor) { self.AddActor(*actor); },
         nb::arg("actor"))
  ...
  nb::class_<viskores::rendering::Canvas>(m, "Canvas")
    ...
    .def("GetColorBuffer",
         [](const viskores::rendering::Canvas& self) {
           return UnknownArrayToNumPyArray(viskores::cont::UnknownArrayHandle(
             self.GetColorBuffer()));
         })
    .def("GetDepthBuffer",
         [](const viskores::rendering::Canvas& self) {
  ...
  nb::class_<viskores::rendering::CanvasRayTracer, viskores::rendering::Canvas>(m,
                                                                                 "CanvasRayTracer")
    .def(nb::init<viskores::IdComponent, viskores::IdComponent>(),
         nb::arg("width") = 1024,
         nb::arg("height") = 1024);
  ...
  nb::class_<viskores::rendering::MapperQuad>(m, "MapperQuad")
    .def(nb::init<>())
    .def("SetCompositeBackground",
  ...
  nb::class_<viskores::rendering::MapperConnectivity>(m, "MapperConnectivity")
    .def(nb::init<>())
    .def("SetSampleDistance",
  ...
  nb::class_<viskores::rendering::MapperCylinder>(m, "MapperCylinder")
    .def(nb::init<>())
    .def("UseVariableRadius",
         [](viskores::rendering::MapperCylinder& self, bool enabled) { self.UseVariableRadius(enabled); },
         nb::arg("enabled"))
    .def("SetRadius",
  ...
  nb::class_<viskores::rendering::MapperGlyphScalar>(m, "MapperGlyphScalar")
    .def(nb::init<>())
    .def("GetGlyphType", &viskores::rendering::MapperGlyphScalar::GetGlyphType)
    .def("SetGlyphType", &viskores::rendering::MapperGlyphScalar::SetGlyphType, nb::arg("glyph_type"))
  ...
  nb::class_<viskores::rendering::MapperGlyphVector>(m, "MapperGlyphVector")
    .def(nb::init<>())
    .def("GetGlyphType", &viskores::rendering::MapperGlyphVector::GetGlyphType)
    .def("SetGlyphType", &viskores::rendering::MapperGlyphVector::SetGlyphType, nb::arg("glyph_type"))
  ...
  nb::class_<viskores::rendering::MapperWireframer>(m, "MapperWireframer")
    .def(nb::init<>())
  ...
  nb::class_<viskores::rendering::MapperRayTracer>(m, "MapperRayTracer")
    .def(nb::init<>())
    .def("SetCompositeBackground",
    ...
    .def("SetShadingOn",
         [](viskores::rendering::MapperRayTracer& self, bool enabled) {
           self.SetShadingOn(enabled);
         },
         nb::arg("enabled"));

  erase_existing_name("ScalarRendererResult");
  nb::class_<viskores::rendering::ScalarRenderer::Result>(m, "ScalarRendererResult")
    .def_prop_ro("Width",
                 [](const viskores::rendering::ScalarRenderer::Result& self) { return self.Width; })
    .def_prop_ro("Height",
                 [](const viskores::rendering::ScalarRenderer::Result& self) { return self.Height; })
    .def_prop_ro("Depths",
                 [](const viskores::rendering::ScalarRenderer::Result& self) {
                   return UnknownArrayToNumPyArray(
                     viskores::cont::UnknownArrayHandle(self.Depths));
                 })
    .def_prop_ro("Scalars",
                 [](const viskores::rendering::ScalarRenderer::Result& self) {
                   nb::list output;
                   ...
                   {
                     output.append(UnknownArrayToNumPyArray(
                       viskores::cont::UnknownArrayHandle(values)));
                   }
                   return output;
                 })
    ...
    .def("ToDataSet",
         [](viskores::rendering::ScalarRenderer::Result& self) { return WrapDataSet(self.ToDataSet()); });

  erase_existing_name("ScalarRenderer");
  nb::class_<viskores::rendering::ScalarRenderer>(m, "ScalarRenderer")
    .def(nb::init<>())
    .def("SetInput",
    ...
    .def("SetDefaultValue",
         &viskores::rendering::ScalarRenderer::SetDefaultValue,
         nb::arg("value"))
    .def("Render",
         [](viskores::rendering::ScalarRenderer& self,
  ...
  nb::class_<viskores::rendering::View3D>(m, "View3D")
    .def("__init__",
         [](viskores::rendering::View3D* self,
           ...
           else
           {
             ...
             new (self) viskores::rendering::View3D(
               *scene, *mapper, *canvas, *camera, background, foreground);
           }
         },
         nb::arg("scene"),
         nb::arg("mapper"),
