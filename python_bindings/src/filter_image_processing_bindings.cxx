  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  nb::class_<viskores::filter::image_processing::ComputeMoments>(m, "ComputeMoments")
    .def(nb::init<>())
    .def("SetActiveField",
    ...
    .def("SetRadius", &viskores::filter::image_processing::ComputeMoments::SetRadius, nb::arg("radius"))
    .def("SetSpacing",
         ...
         nb::arg("spacing"))
    .def("SetOrder", &viskores::filter::image_processing::ComputeMoments::SetOrder, nb::arg("order"))
    .def("Execute",
  ...
  nb::class_<viskores::filter::image_processing::ImageDifference>(m, "ImageDifference")
    .def(nb::init<>())
    .def("SetPrimaryField",
  ...
  nb::class_<viskores::filter::image_processing::ImageMedian>(m, "ImageMedian")
    .def(nb::init<>())
    .def("SetActiveField",
    ...
    .def("SetOutputFieldName",
         &viskores::filter::image_processing::ImageMedian::SetOutputFieldName)
    .def("GetOutputFieldName",
         &viskores::filter::image_processing::ImageMedian::GetOutputFieldName)
