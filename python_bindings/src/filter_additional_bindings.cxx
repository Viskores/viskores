  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  nb::class_<viskores::filter::entity_extraction::Threshold>(m, "Threshold")
    .def(nb::init<>())
    .def("SetActiveField",
    ...
    .def("SetOutputFieldName",
         &viskores::filter::entity_extraction::Threshold::SetOutputFieldName)
    .def("GetOutputFieldName",
         &viskores::filter::entity_extraction::Threshold::GetOutputFieldName)
    .def("SetFieldsToPass",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::entity_extraction::Threshold>);

  erase_existing_name("Mask");
  nb::class_<viskores::filter::entity_extraction::Mask>(m, "Mask")
    .def(nb::init<>())
    .def("SetFieldsToPass",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::entity_extraction::Mask>);

  erase_existing_name("MaskPoints");
  nb::class_<viskores::filter::entity_extraction::MaskPoints>(m, "MaskPoints")
    .def(nb::init<>())
    .def("SetFieldsToPass",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::entity_extraction::MaskPoints>);

  erase_existing_name("ThresholdPoints");
  nb::class_<viskores::filter::entity_extraction::ThresholdPoints>(m, "ThresholdPoints")
    .def(nb::init<>())
    .def("SetActiveField",
    ...
    .def("SetThresholdBetween",
         ...
         nb::arg("lower"),
         nb::arg("upper"))
    .def("Execute", &ExecuteFilterToPython<viskores::filter::entity_extraction::ThresholdPoints>);

  erase_existing_name("ExternalFaces");
  nb::class_<viskores::filter::entity_extraction::ExternalFaces>(m, "ExternalFaces")
    .def(nb::init<>())
    .def("SetFieldsToPass",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::entity_extraction::ExternalFaces>);

  erase_existing_name("ExtractStructured");
  nb::class_<viskores::filter::entity_extraction::ExtractStructured>(m, "ExtractStructured")
    .def(nb::init<>())
    .def("SetFieldsToPass",
    ...
    .def("SetSampleRate",
         [](viskores::filter::entity_extraction::ExtractStructured& self, nb::args args) {
           ...
           if (args.size() != 3)
           {
             throw std::runtime_error("SetSampleRate expects a dimensions object or 3 integer values.");
           }
           long long values[3];
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::entity_extraction::ExtractStructured>);

  erase_existing_name("ExtractPoints");
  nb::class_<viskores::filter::entity_extraction::ExtractPoints>(m, "ExtractPoints")
    .def(nb::init<>())
    .def("SetImplicitFunction",
         [](viskores::filter::entity_extraction::ExtractPoints& self, nb::object functionObject) {
           SetImplicitFunction(self, functionObject);
         },
         nb::arg("function"))
    .def("SetExtractInside",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::entity_extraction::ExtractPoints>);

  erase_existing_name("ExtractGeometry");
  nb::class_<viskores::filter::entity_extraction::ExtractGeometry>(m, "ExtractGeometry")
    .def(nb::init<>())
    .def("SetImplicitFunction",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::entity_extraction::ExtractGeometry>);

  erase_existing_name("GhostCellRemove");
  nb::class_<viskores::filter::entity_extraction::GhostCellRemove>(m, "GhostCellRemove")
    .def(nb::init<>())
    .def("SetActiveField",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::entity_extraction::GhostCellRemove>);
}
#else
  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  nb::class_<viskores::filter::clean_grid::CleanGrid>(m, "CleanGrid")
    .def(nb::init<>())
    .def("SetFieldsToPass",
    ...
    .def("SetTolerance",
         [](viskores::filter::clean_grid::CleanGrid& self, double value) {
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::clean_grid::CleanGrid>);
#endif

#if VISKORES_PYTHON_ENABLE_FILTER_MESH_INFO
  erase_existing_name("GhostCellClassify");
  nb::class_<viskores::filter::mesh_info::GhostCellClassify>(m, "GhostCellClassify")
    .def(nb::init<>())
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::mesh_info::GhostCellClassify>);

  erase_existing_name("CellMeasures");
  nb::class_<viskores::filter::mesh_info::CellMeasures>(m, "CellMeasures")
    .def(nb::init<>())
    .def("SetMeasure",
    ...
    .def("SetCellMeasureName", &viskores::filter::mesh_info::CellMeasures::SetCellMeasureName, nb::arg("name"))
    .def("GetCellMeasureName", &viskores::filter::mesh_info::CellMeasures::GetCellMeasureName)
    .def("Execute", &ExecuteFilterToPython<viskores::filter::mesh_info::CellMeasures>);

  erase_existing_name("MeshQuality");
  nb::class_<viskores::filter::mesh_info::MeshQuality>(m, "MeshQuality")
    .def(nb::init<>())
    .def("SetMetric",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::mesh_info::MeshQuality>);
#endif

#if VISKORES_PYTHON_ENABLE_FILTER_CONNECTED_COMPONENTS
  erase_existing_name("CellSetConnectivity");
  nb::class_<viskores::filter::connected_components::CellSetConnectivity>(m, "CellSetConnectivity")
    .def(nb::init<>())
    .def("SetOutputFieldName",
  ...
  nb::class_<viskores::filter::connected_components::ImageConnectivity>(m, "ImageConnectivity")
    .def(nb::init<>())
    .def("SetActiveField",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::connected_components::ImageConnectivity>);
#endif

#if VISKORES_PYTHON_ENABLE_FILTER_MULTI_BLOCK
  erase_existing_name("MergeDataSets");
  nb::class_<viskores::filter::multi_block::MergeDataSets>(m, "MergeDataSets")
    .def(nb::init<>())
    .def("SetInvalidValue",
    ...
    .def("Execute", &ExecuteFilterToPython<viskores::filter::multi_block::MergeDataSets>);
#endif
}
#else
