  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  nb::class_<viskores::filter::density_estimate::ContinuousScatterPlot>(m, "ContinuousScatterPlot")
    .def(nb::init<>())
    .def("SetActiveFieldsPair",
  ...
  nb::class_<viskores::filter::density_estimate::Entropy>(m, "Entropy")
    .def(nb::init<>())
    .def("SetActiveField",
  ...
  nb::class_<viskores::filter::density_estimate::Histogram>(m, "Histogram")
    .def(nb::init<>())
    .def("SetActiveField",
  ...
  nb::class_<viskores::filter::density_estimate::NDEntropy>(m, "NDEntropy")
    .def(nb::init<>())
    .def("AddFieldAndBin",
  ...
  nb::class_<viskores::filter::density_estimate::NDHistogram>(m, "NDHistogram")
    .def(nb::init<>())
    .def("AddFieldAndBin",
         ...
         nb::arg("field_name"),
         nb::arg("num_bins"))
    .def("GetBinDelta", &viskores::filter::density_estimate::NDHistogram::GetBinDelta, nb::arg("field_index"))
    .def("GetDataRange", &viskores::filter::density_estimate::NDHistogram::GetDataRange, nb::arg("field_index"))
    .def("Execute",
  ...
  nb::class_<viskores::filter::density_estimate::Statistics>(m, "Statistics")
    .def(nb::init<>())
    .def("SetActiveField",
  ...
  nb::class_<viskores::filter::density_estimate::ParticleDensityNearestGridPoint>(
    m, "ParticleDensityNearestGridPoint")
    .def(nb::init<>())
    .def("SetActiveField",
    ...
    .def("SetOrigin",
         [](viskores::filter::density_estimate::ParticleDensityNearestGridPoint& self,
            nb::handle originObject) {
           self.SetOrigin(ParseVec3(originObject, self.GetOrigin()));
         },
         nb::arg("origin"))
    .def("GetOrigin",
         [](const viskores::filter::density_estimate::ParticleDensityNearestGridPoint& self) {
