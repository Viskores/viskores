  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  nb::class_<viskores::filter::field_conversion::CellAverage>(m, "CellAverage")
    .def(nb::init<>())
    .def("SetActiveField",
  ...
  nb::class_<viskores::filter::field_conversion::PointAverage>(m, "PointAverage")
    .def(nb::init<>())
    .def("SetActiveField",
         ...
         nb::arg("name"),
         nb::arg("association") = nb::none())
    .def("GetActiveFieldName", &viskores::filter::field_conversion::PointAverage::GetActiveFieldName)
    .def("SetOutputFieldName", &viskores::filter::field_conversion::PointAverage::SetOutputFieldName)
    .def("GetOutputFieldName", &viskores::filter::field_conversion::PointAverage::GetOutputFieldName)
    .def("SetUseCoordinateSystemAsField",
  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  nb::class_<viskores::filter::vector_analysis::VectorMagnitude>(m, "VectorMagnitude")
    .def(nb::init<>())
    .def("SetActiveField",
         ...
         nb::arg("name"),
         nb::arg("association") = nb::none())
    .def("GetActiveFieldName", &viskores::filter::vector_analysis::VectorMagnitude::GetActiveFieldName)
    .def("SetOutputFieldName", &viskores::filter::vector_analysis::VectorMagnitude::SetOutputFieldName)
    .def("GetOutputFieldName", &viskores::filter::vector_analysis::VectorMagnitude::GetOutputFieldName)
    .def("SetUseCoordinateSystemAsField",
  ...
  nb::class_<viskores::filter::vector_analysis::Gradient>(m, "Gradient")
    .def(nb::init<>())
    .def("SetActiveField",
    ...
    .def("SetColumnMajorOrdering", &viskores::filter::vector_analysis::Gradient::SetColumnMajorOrdering)
  ...
  nb::class_<viskores::filter::vector_analysis::CrossProduct>(m, "CrossProduct")
    .def(nb::init<>())
    .def("SetPrimaryField",
         ...
         nb::arg("name"),
         nb::arg("association") = nb::none())
    .def("GetPrimaryFieldName", &viskores::filter::vector_analysis::CrossProduct::GetPrimaryFieldName)
    ...
    .def("SetSecondaryField",
         ...
         nb::arg("name"),
         nb::arg("association") = nb::none())
    .def("GetSecondaryFieldName", &viskores::filter::vector_analysis::CrossProduct::GetSecondaryFieldName)
  ...
  nb::class_<viskores::filter::vector_analysis::DotProduct>(m, "DotProduct")
    .def(nb::init<>())
    .def("SetPrimaryField",
    ...
    .def("SetSecondaryField",
         ...
         nb::arg("name"),
         nb::arg("association") = nb::none())
    .def("GetSecondaryFieldName", &viskores::filter::vector_analysis::DotProduct::GetSecondaryFieldName)
    .def("GetSecondaryFieldAssociation",
  ...
  nb::class_<viskores::filter::vector_analysis::SurfaceNormals>(m, "SurfaceNormals")
    .def(nb::init<>())
  ...
  const std::function<void(const char*)>& erase_existing_name)
{
  ...
  nb::class_<viskores::filter::contour::Contour>(m, "Contour")
    .def(nb::init<>())
    .def("SetIsoValue",
    ...
    .def("SetIsoValues",
         ...
         nb::arg("values"))
    .def("SetActiveField",
         [](viskores::filter::contour::Contour& self,
            const char* name,
            nb::object associationObject) {
           self.SetActiveField(
             name, ParseAssociation(associationObject, viskores::cont::Field::Association::Any));
  ...
  nb::class_<viskores::filter::contour::ContourMarchingCells>(m, "ContourMarchingCells")
    .def(nb::init<>())
    .def("SetIsoValue",
  ...
  nb::class_<viskores::filter::contour::ClipWithImplicitFunction>(m, "ClipWithImplicitFunction")
    .def(nb::init<>())
         ...
         [](viskores::filter::contour::ClipWithImplicitFunction& self, nb::object functionObject) {
           ...
           if (!ParseImplicitFunction(functionObject, function))
           {
             throw std::runtime_error(
               "Implicit function must be a viskores.Box, viskores.Cylinder, viskores.Plane, or viskores.Sphere.");
           }
           self.SetImplicitFunction(function);
         },
         nb::arg("function"))
    .def("SetOffset", &viskores::filter::contour::ClipWithImplicitFunction::SetOffset, nb::arg("offset"))
  ...
  nb::class_<viskores::filter::contour::Slice, viskores::filter::contour::Contour>(m, "Slice")
    .def(nb::init<>())
    .def("SetImplicitFunction",
  ...
  nb::class_<viskores::filter::contour::ClipWithField>(m, "ClipWithField")
    .def(nb::init<>())
    .def("SetActiveField",
    ...
    .def("SetInvertClip",
         &viskores::filter::contour::ClipWithField::SetInvertClip,
         nb::arg("invert"))
  ...
  nb::class_<viskores::filter::contour::MIRFilter>(m, "MIRFilter")
    .def(nb::init<>())
