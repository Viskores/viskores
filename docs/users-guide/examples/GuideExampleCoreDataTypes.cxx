...
void EquilateralTriangle()
{
  ...
  viskores::Vec<viskores::Vec2f_32, 3> edges(
...
////
VISKORES_EXEC viskores::VecCConst<viskores::IdComponent> HexagonIndexToIJK(
...
VISKORES_EXEC viskores::IdComponent HexagonIJKToIndex(
  viskores::VecCConst<viskores::IdComponent> ijk)
{
...
////
viskores::VecVariable<viskores::IdComponent, 4> HexagonShortestPath(
  viskores::IdComponent startPoint,
...
void UsingVecCAndVecVariable()
{
  ...
  VISKORES_TEST_ASSERT(test_equal(path, viskores::Vec<viskores::IdComponent, 1>(2)),
                       "Bad path");
