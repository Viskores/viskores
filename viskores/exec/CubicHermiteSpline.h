...
public:
  ...
  VISKORES_EXEC viskores::ErrorCode Evaluate(const viskores::FloatDefault& tVal, viskores::Vec3f& val) const
  {
  ...
  VISKORES_EXEC bool GetInterval(const viskores::FloatDefault& tVal,
    viskores::Vec3f& p0, viskores::Vec3f& p1,
    viskores::FloatDefault& t0, viskores::FloatDefault& t1,
    viskores::Vec3f& m0, viskores::Vec3f& m1)const
  {
