...
public:
  ...
  using ControlSignature = void(FieldIn, FieldInOut, FieldInOut, WholeArrayIn, WholeArrayIn);
...
template <typename Precision>
void CylinderIntersector::IntersectionDataImp(
  Ray<Precision>& rays,
...
void CylinderIntersector::IntersectionData(
