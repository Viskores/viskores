...
void TestEndsWith()
{
  ...
  VISKORES_TEST_ASSERT(EndsWith("special_char$&#*", "_char$&#*"), "Ending did not match '_char$&#*'");
...
{
  VISKORES_TEST_ASSERT(GetWindowsPathSeperator("some/test/path") == '/', "/ should be the separator");
  VISKORES_TEST_ASSERT(GetWindowsPathSeperator("some\\test\\path") == '\\',
                   "\\ should be the seperator");
  VISKORES_TEST_ASSERT(GetWindowsPathSeperator("some\\test/path") == '/', "Always prefer / over \\");
  VISKORES_TEST_ASSERT(GetWindowsPathSeperator("some/test\\path") == '/', "Always prefer / over \\");
}
...
void TestFilename()
{
  ...
  VISKORES_TEST_ASSERT(Filename("test/path/filename.txt") == "filename.txt", "Should strip linux path");
  VISKORES_TEST_ASSERT(Filename("test/path/dir/") == "", "Should return empty string if ends in a dir");
#ifdef _MSC_VER
...
void TestParentPath()
{
  ...
  VISKORES_TEST_ASSERT(ParentPath("test/path/filename.txt") == "test/path", "Should strip Linux file");
...
void TestPrefixStringToFilename()
{
  ...
  VISKORES_TEST_ASSERT(PrefixStringToFilename("some/path/filename.txt", "") == "some/path/filename.txt",
