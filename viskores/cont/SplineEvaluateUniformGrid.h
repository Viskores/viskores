...
#ifndef viskores_cont_SplineEvaluateUniformGrid_h
#define viskores_cont_SplineEvaluateUniformGrid_h

#include <viskores/cont/DataSet.h>
#include <viskores/exec/SplineEvaluateUniformGrid.h>
...
/// @brief Grid evaluation for uniform grids using spline interpolation.
///
...
/// means the data set must use a `viskores::cont::ArrayHandleUniformPointCoordinates`
/// for its coordinate system. This evaluator will throw an error if the data set does
...
#endif //viskores_cont_SplineEvaluateUniformGrid_h
