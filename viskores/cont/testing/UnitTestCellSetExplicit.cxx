...
viskores::cont::CellSetExplicit<> MakeTestCellSet1()
{
  ...
  cs.Fill(
    ...
    viskores::cont::make_ArrayHandle(g_connectivity, ArrayLength(g_connectivity), viskores::CopyFlag::Off),
...
void TestCellSetExplicit()
{
  ...
  {
    viskores::cont::ScopedRuntimeDeviceTracker deviceScope(viskores::cont::DeviceAdapterTagSerial{});
    (void)deviceScope;
