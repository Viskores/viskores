...
//============================================================================
#ifndef viskores_worklet_DispatcherCellNeighborhood_h
#define viskores_worklet_DispatcherCellNeighborhood_h
...
public:
  template <typename... T>
  VISKORES_CONT DispatcherCellNeighborhood(T&&... args)
  ...
  void DoInvoke(Invocation& invocation) const
  {
    ...
    auto inputRange = SchedulingRange(inputDomain, viskores::TopologyElementTagCell{});
...
#endif //viskores_worklet_DispatcherCellNeighborhood_h
