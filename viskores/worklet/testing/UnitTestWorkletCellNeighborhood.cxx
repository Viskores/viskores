...
struct Subsample : public viskores::worklet::WorkletCellNeighborhood
{
  using ControlSignature =
    void(WholeCellSetIn<viskores::TopologyElementTagCell, viskores::TopologyElementTagPoint> inputTopology,
  ...
  VISKORES_EXEC void operator()(const viskores::exec::ConnectivityStructured<viskores::TopologyElementTagCell,
...
static void TestMaxNeighborValue()
{
  ...
  viskores::worklet::DispatcherCellNeighborhood<::test_cellneighborhood::MaxNeighborValue> dispatcher;
