...
{
  {
    ...
    VISKORES_TEST_ASSERT(selection.IsFieldSelected("bar", viskores::cont::Field::Association::Points) ==
                       false,
...

  {
    ...
    VISKORES_TEST_ASSERT(selection.IsFieldSelected("foo") == true, "field selection failed.");
    VISKORES_TEST_ASSERT(selection.IsFieldSelected("foo", viskores::cont::Field::Association::Points) ==
                       true,
                     "field selection failed.");
    VISKORES_TEST_ASSERT(selection.IsFieldSelected("foo", viskores::cont::Field::Association::Cells) ==
                       true,
                     "field selection failed.");
...

  {
    ...
    VISKORES_TEST_ASSERT(selection.IsFieldSelected("bar", viskores::cont::Field::Association::Points) ==
                       false,
                     "field selection failed.");
    VISKORES_TEST_ASSERT(selection.IsFieldSelected("bar", viskores::cont::Field::Association::Cells) ==
                       true,
                     "field selection failed.");
...

  {
    ...
    viskores::filter::FieldSelection selection{ pair_type{ "foo", viskores::cont::Field::Association::Any },
                                            pair_type{ "bar",
