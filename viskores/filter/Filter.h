...
public:
  ...
  VISKORES_DEPRECATED(1.2, "Multi-threaded CPU filters not supported.")
  VISKORES_CONT
  void SetThreadsPerCPU(viskores::Id viskoresNotUsed(numThreads)) {}
  ...
  VISKORES_DEPRECATED(1.2, "Multi-threaded CPU filters not supported.")
  VISKORES_CONT
  viskores::Id GetThreadsPerCPU() const { return 1; }
