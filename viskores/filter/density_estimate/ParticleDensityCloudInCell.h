...
#ifndef viskores_filter_density_estimate_ParticleDensityCIC_h
#define viskores_filter_density_estimate_ParticleDensityCIC_h
...
#endif // viskores_filter_density_estimate_ParticleDensityCIC_h
