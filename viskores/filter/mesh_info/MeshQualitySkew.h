...
//  this software.
//============================================================================
#ifndef viskores_filter_mesh_info_MeshQualitySkew_h
#define viskores_filter_mesh_info_MeshQualitySkew_h
...
class VISKORES_FILTER_MESH_INFO_EXPORT MeshQualitySkew : public viskores::filter::Filter
{
public:
  MeshQualitySkew();
...
#endif //viskores_filter_mesh_info_MeshQualitySkew_h
