...
#include <viskores/filter/mesh_info/worklet/cellmetrics/CellShearMetric.h>

namespace
{

struct ShearWorklet : MeshQualityWorklet<ShearWorklet>
{
  ...
  {
    return viskores::worklet::cellmetrics::CellShearMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
MeshQualityShear::MeshQualityShear()
{
  ...
  this->SetOutputFieldName("shear");
}

viskores::cont::DataSet MeshQualityShear::DoExecute(const viskores::cont::DataSet& input)
{
