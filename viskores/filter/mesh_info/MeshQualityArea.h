...
//  this software.
//============================================================================
#ifndef viskores_filter_mesh_info_MeshQualityArea_h
#define viskores_filter_mesh_info_MeshQualityArea_h
...
class VISKORES_FILTER_MESH_INFO_EXPORT MeshQualityArea : public viskores::filter::Filter
{
public:
  MeshQualityArea();

  /// @brief Computes the area of all polygonal cells and returns the total area.
  viskores::Float64 ComputeTotalArea(const viskores::cont::DataSet& input);
  ...
  viskores::Float64 ComputeAverageArea(const viskores::cont::DataSet& input);
...
#endif //viskores_filter_mesh_info_MeshQualityArea_h
