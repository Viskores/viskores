...
//  this software.
//============================================================================
#ifndef viskores_worklet_cellmetrics_CellMaxAngleMetric_h
#define viskores_worklet_cellmetrics_CellMaxAngleMetric_h
...
VISKORES_EXEC OutType CellMaxAngleMetric(const viskores::IdComponent& numPts,
                                     ...
                                     viskores::ErrorCode& ec)
{
  ...
  const Scalar q = viskores::Max(q0, viskores::Max(q1, q2));
...
#endif // viskores_worklet_cellmetrics_CellMaxAngleMetric_h
