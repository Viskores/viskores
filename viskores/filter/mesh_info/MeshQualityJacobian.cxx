...
#include <viskores/filter/mesh_info/worklet/cellmetrics/CellJacobianMetric.h>
...
struct JacobianWorklet : MeshQualityWorklet<JacobianWorklet>
{
  ...
  {
    return viskores::worklet::cellmetrics::CellJacobianMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
viskores::cont::DataSet MeshQualityJacobian::DoExecute(const viskores::cont::DataSet& input)
{
