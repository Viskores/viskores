...
#include <viskores/filter/mesh_info/worklet/cellmetrics/CellSkewMetric.h>
...
struct SkewWorklet : MeshQualityWorklet<SkewWorklet>
{
  ...
  {
    return viskores::worklet::cellmetrics::CellSkewMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
viskores::cont::DataSet MeshQualitySkew::DoExecute(const viskores::cont::DataSet& input)
{
