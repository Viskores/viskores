...
#include <viskores/filter/mesh_info/worklet/cellmetrics/CellShapeMetric.h>

namespace
{

struct ShapeWorklet : MeshQualityWorklet<ShapeWorklet>
{
...
MeshQualityShape::MeshQualityShape()
{
  ...
  this->SetOutputFieldName("shape");
}

viskores::cont::DataSet MeshQualityShape::DoExecute(const viskores::cont::DataSet& input)
{
