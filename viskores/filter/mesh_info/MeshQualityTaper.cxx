...
#include <viskores/filter/mesh_info/worklet/cellmetrics/CellTaperMetric.h>

namespace
{

struct TaperWorklet : MeshQualityWorklet<TaperWorklet>
{
  ...
  {
    return viskores::worklet::cellmetrics::CellTaperMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
MeshQualityTaper::MeshQualityTaper()
{
  ...
  this->SetOutputFieldName("taper");
}

viskores::cont::DataSet MeshQualityTaper::DoExecute(const viskores::cont::DataSet& input)
{
