...
template <>
class MarchingCellTables<3>
{
  VISKORES_EXEC static inline viskores::IdComponent GetNumOutCellsOffset(viskores::UInt8 inCellType)
  {
    // clang-format off
    ...
    return offsets[inCellType];
  }

  VISKORES_EXEC static inline viskores::IdComponent GetOutCellTableOffset(viskores::UInt8 inCellType,
                                                                  viskores::UInt8 caseNumber)
  {
    // clang-format off
    VISKORES_STATIC_CONSTEXPR_ARRAY viskores::IdComponent tableOffset[] = {
      // CELL_SHAPE_EMPTY
      // CELL_SHAPE_VERTEX
    ...
    viskores::IdComponent offset = GetNumOutCellsOffset(inCellType);
    return tableOffset[offset + caseNumber];
  }

public:
  VISKORES_EXEC static inline viskores::UInt8 GetNumOutCells(viskores::UInt8 inCellType, viskores::UInt8 caseNumber)
  {
    // clang-format off
    VISKORES_STATIC_CONSTEXPR_ARRAY viskores::UInt8 numOutCells[] = {
      // CELL_SHAPE_EMPTY
      // CELL_SHAPE_VERTEX
      // CELL_SHAPE_POLY_VERTEX
      // CELL_SHAPE_LINE
    ...
    viskores::IdComponent offset = GetNumOutCellsOffset(inCellType);
    if (offset == GetNumOutCellsOffset(inCellType + 1))
    {
      // This part of the table is empty.
      return 0;
    }
    else
    {
      return numOutCells[offset + caseNumber];
    }
  }

  VISKORES_EXEC static inline const viskores::UInt8* GetCellEdges(viskores::UInt8 inCellType,
                                                          viskores::UInt8 caseNumber,
                                                          viskores::UInt8 outCellNumber)
  {
    // clang-format off
    VISKORES_STATIC_CONSTEXPR_ARRAY viskores::UInt8 triTable[][3] = {
      ...
      { 5, 3, 2 }, { 3, 0, 2 }, // case 9
      { 0, 7, 1 }, { 6, 5, 3 }, // case 10
      { 2, 5, 1 }, { 1, 5, 3 }, { 1, 3, 7 }, // case 11
      { 2, 1, 8 }, { 6, 5, 3 }, // case 12
      { 1, 8, 5 }, { 1, 5, 3 }, { 1, 3, 0 }, // case 13
      { 6, 5, 3 }, { 2, 7, 8 }, { 2, 0, 7 }, // case 14
      { 8, 5, 3 }, { 8, 3, 7 }, // case 15
      { 4, 7, 3 }, // case 16
      { 4, 7, 3 }, { 2, 6, 0 }, // case 17
      { 1, 3, 4 }, { 0, 3, 1 }, // case 18
      { 1, 3, 4 }, { 1, 6, 3 }, { 1, 2, 6 }, // case 19
      { 4, 7, 3 }, { 2, 1, 8 }, // case 20
      { 4, 7, 3 }, { 6, 1, 8 }, { 6, 0, 1 }, // case 21
      { 3, 4, 8 }, { 3, 8, 2 }, { 3, 2, 0 }, // case 22
      { 6, 4, 8 }, { 6, 3, 4 }, // case 23
      { 6, 5, 7 }, { 5, 4, 7 }, // case 24
      { 2, 5, 4 }, { 2, 4, 7 }, { 2, 7, 0 }, // case 25
      { 0, 6, 1 }, { 6, 5, 1 }, { 5, 4, 1 }, // case 26
      { 2, 5, 1 }, { 1, 5, 4 }, // case 27
      { 8, 2, 1 }, { 6, 5, 4 }, { 6, 4, 7 }, // case 28
      { 1, 8, 5 }, { 1, 5, 0 }, { 0, 5, 7 }, { 7, 5, 4 }, // case 29
      { 8, 2, 4 }, { 4, 2, 0 }, { 4, 0, 5 }, { 5, 0, 6 }, // case 30
      { 8, 5, 4 }, // case 31
      { 8, 4, 5 }, // case 32
      { 8, 4, 5 }, { 2, 6, 0 }, // case 33
      { 8, 4, 5 }, { 0, 7, 1 }, // case 34
      { 8, 4, 5 }, { 6, 1, 2 }, { 6, 7, 1 }, // case 35
      { 2, 1, 5 }, { 1, 4, 5 }, // case 36
      { 1, 4, 5 }, { 1, 5, 6 }, { 1, 6, 0 }, // case 37
      { 2, 4, 5 }, { 2, 7, 4 }, { 2, 0, 7 }, // case 38
      { 6, 7, 5 }, { 5, 7, 4 }, // case 39
      { 6, 8, 4 }, { 6, 4, 3 }, // case 40
      { 2, 8, 3 }, { 8, 4, 3 }, { 0, 2, 3 }, // case 41
      { 0, 7, 1 }, { 6, 8, 3 }, { 8, 4, 3 }, // case 42
      { 2, 8, 3 }, { 8, 4, 3 }, { 2, 3, 1 }, { 1, 3, 7 }, // case 43
      { 1, 6, 2 }, { 1, 3, 6 }, { 1, 4, 3 }, // case 44
      { 0, 1, 3 }, { 3, 1, 4 }, // case 45
      { 2, 0, 7 }, { 2, 7, 4 }, { 2, 4, 3 }, { 2, 3, 6 }, // case 46
      { 7, 4, 3 }, // case 47
      { 8, 7, 3 }, { 8, 3, 5 }, // case 48
      { 2, 6, 0 }, { 8, 7, 3 }, { 8, 3, 5 }, // case 49
      { 1, 5, 8 }, { 1, 3, 5 }, { 1, 0, 3 }, // case 50
      { 1, 2, 6 }, { 1, 6, 3 }, { 1, 3, 8 }, { 8, 3, 5 }, // case 51
      { 2, 1, 5 }, { 1, 3, 5 }, { 1, 7, 3 }, // case 52
      { 0, 1, 6 }, { 6, 1, 5 }, { 3, 1, 7 }, { 5, 1, 3 }, // case 53
      { 2, 0, 3 }, { 2, 3, 5 }, // case 54
      { 5, 6, 3 }, // case 55
      { 8, 7, 6 }, // case 56
      { 2, 8, 7 }, { 2, 7, 0 }, // case 57
    ...
    viskores::IdComponent offset = GetOutCellTableOffset(inCellType, caseNumber);
    return triTable[offset + outCellNumber];
  }
};

template <>
class MarchingCellTables<2>
{
  VISKORES_EXEC static inline viskores::IdComponent GetNumOutCellsOffset(viskores::UInt8 inCellType)
  {
    // clang-format off
    VISKORES_STATIC_CONSTEXPR_ARRAY viskores::IdComponent offsets[] = {
      ...
      0, // CELL_SHAPE_POLY_LINE
      0, // CELL_SHAPE_TRIANGLE
      8, // CELL_SHAPE_TRIANGLE_STRIP
      8, // CELL_SHAPE_POLYGON
      8, // CELL_SHAPE_PIXEL
      8, // CELL_SHAPE_QUAD
      24, // CELL_SHAPE_TETRA
      24, // CELL_SHAPE_VOXEL
      24, // CELL_SHAPE_HEXAHEDRON
      24, // CELL_SHAPE_WEDGE
      24, // CELL_SHAPE_PYRAMID
      24 // table size
    };
    // clang-format on
                                                                  ...
                                                                  viskores::UInt8 caseNumber)
  {
    ...
    VISKORES_STATIC_CONSTEXPR_ARRAY viskores::IdComponent tableOffset[] = {
      ...
      // CELL_SHAPE_POLY_LINE
      // CELL_SHAPE_TRIANGLE
      0, 0, 1, 2, 3, 4, 5, 6,   // cases 0 - 7
      // CELL_SHAPE_TRIANGLE_STRIP
      // CELL_SHAPE_POLYGON
      // CELL_SHAPE_PIXEL
      // CELL_SHAPE_QUAD
      6, 6, 7, 8, 9, 10, 12, 13,   // cases 0 - 7
      14, 15, 16, 18, 19, 20, 21, 22,   // cases 8 - 15
      // CELL_SHAPE_TETRA
      // CELL_SHAPE_VOXEL
      // CELL_SHAPE_HEXAHEDRON
      // CELL_SHAPE_WEDGE
...
public:
  VISKORES_EXEC static inline viskores::UInt8 GetNumOutCells(viskores::UInt8 inCellType, viskores::UInt8 caseNumber)
  {
    ...
    VISKORES_STATIC_CONSTEXPR_ARRAY viskores::UInt8 numOutCells[] = {
      ...
      // CELL_SHAPE_POLY_LINE
      // CELL_SHAPE_TRIANGLE
      0, 1, 1, 1, 1, 1, 1, 0,   // cases 0 - 7
      // CELL_SHAPE_TRIANGLE_STRIP
      // CELL_SHAPE_POLYGON
      // CELL_SHAPE_PIXEL
      // CELL_SHAPE_QUAD
      0, 1, 1, 1, 1, 2, 1, 1, 1, 1, 2, 1, 1, 1, 1, 0,   // cases 0 - 15
      // CELL_SHAPE_TETRA
      // CELL_SHAPE_VOXEL
      // CELL_SHAPE_HEXAHEDRON
      // CELL_SHAPE_WEDGE
  ...
  {
    // clang-format off
    VISKORES_STATIC_CONSTEXPR_ARRAY viskores::UInt8 lineTable[][2] = {
      // CELL_SHAPE_EMPTY
      // CELL_SHAPE_VERTEX
      // CELL_SHAPE_POLY_VERTEX
      // CELL_SHAPE_LINE
    ...
    viskores::IdComponent offset = GetOutCellTableOffset(inCellType, caseNumber);
    return lineTable[offset + outCellNumber];
  }
};

template <viskores::UInt8 Dims>
VISKORES_EXEC inline viskores::UInt8 GetNumOutCells(viskores::UInt8 inCellType, viskores::UInt8 caseNumber)
{
  return MarchingCellTables<Dims>::GetNumOutCells(inCellType, caseNumber);
}

template <viskores::UInt8 Dims>
VISKORES_EXEC inline const viskores::UInt8* GetCellEdges(viskores::UInt8 inCellType,
                                                 viskores::UInt8 caseNumber,
                                                 viskores::UInt8 triangleNumber)
{
  return MarchingCellTables<Dims>::GetCellEdges(inCellType, caseNumber, triangleNumber);
}
