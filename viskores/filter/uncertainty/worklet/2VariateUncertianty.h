...
#ifndef viskores_worklet_uncertainty_Fiber_inner_h
#define viskores_worklet_uncertainty_Fiber_inner_h
#include <iostream>
#include <utility>
#include <vector>
    ...
    namespace detail
    {
      ...
      public:
                                  ...
                                  OutCellFieldType &probability) const
        {
          ...
          viskores::IdComponent NonZeroCases = 0;
      ...
      public:
                                  ...
                                  OutCellFieldType &probability) const
        {
          ...
          if ((maxX_dataset <= maxX_user) && (minX_dataset >= minX_user) && (maxY_dataset <= maxY_user) && (minY_dataset >= minY_user))
          {
            probability = 1.0;
            return;
          }
