...
#ifndef viskores_filter_zfp_ZFPCompressor2D_h
#define viskores_filter_zfp_ZFPCompressor2D_h
...
///
/// Takes as input a 2D array and generates an
/// output of compressed data.
/// @warning
/// This filter is currently only supports 2D structured cell sets.
class VISKORES_FILTER_ZFP_EXPORT ZFPCompressor2D : public viskores::filter::Filter
{
public:
...
#endif // viskores_filter_zfp_ZFPCompressor2D_h
