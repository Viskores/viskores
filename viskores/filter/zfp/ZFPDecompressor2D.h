...
#ifndef viskores_filter_zfp_ZFPDecompressor2D_h
#define viskores_filter_zfp_ZFPDecompressor2D_h
...
///
/// Takes as input a 2D compressed array and generates
/// the decompressed version of the data.
/// @warning
/// This filter is currently only supports 2D structured cell sets.
class VISKORES_FILTER_ZFP_EXPORT ZFPDecompressor2D : public viskores::filter::Filter
{
public:
...
#endif // viskores_filter_zfp_ZFPDecompressor2D_h
