...
//============================================================================
#ifndef viskores_worklet_zfp_2d_decompressor_h
#define viskores_worklet_zfp_2d_decompressor_h
...
#include <viskores/filter/zfp/worklet/zfp/ZFPDecode2.h>
...
public:
                  ...
                  viskores::Id2 dims)
  {
    ...
    viskores::Id totalBlocks = (paddedDims[0] / four) * (paddedDims[1] / (four));
    ...
    //    Timer timer;
    viskores::worklet::DispatcherMapField<zfp::Decode2> decompressDispatcher(
...
#endif //  viskores_worklet_zfp_2d_decompressor_h
