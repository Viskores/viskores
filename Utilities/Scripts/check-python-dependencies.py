...
def read_requirements(path):
    ...
    def read_file(requirements_path):
        ...
        for line_number, line in enumerate(
            ...
            included = re.match(r"^-r\s*(.+)$", requirement)
            if included:
                included_path = requirements_path.parent / included.group(1).strip()
                read_file(included_path)
